        ...
        <div class="pcoded-main-container">
            <div class="pcoded-content">
                            ...
                            <div class="panel-body">
                                <table width="100%" class="table table-striped table-bordered table-hover" id="myTable">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <input type="hidden" class="view_val" value="{{ $data->id}}">
                                            ...
                                            <a href="" data-bs-toggle="modal" class="btn btn-success viewhistry">View Histry</a>
                ...
                <script>
                    ...
                    $(".viewhistry").click(function(e){
                    e.preventDefault();
                    console.log("done");
                        var slug = $(this).closest("tr").find('.view_val').val();
                        var url = '{{ route("viewhistry", ":slug") }}';
